import pickle
import pandas as pd
from answer_extractor.preprocessing import (
    Features,
...
class AnswerExtractor:
    ...
    def _init_answer_df(self, answer: str):
        ...
        for feature_word in SELECTED_FEATURE_WORDS:
            answer_df["count_" + feature_word] = answer_df["Answer"].str.count(
                feature_word
            )
...
if __name__ == "__main__":
    ...
    extractor = AnswerExtractor(
        model=model, pos_vectorizer=pos_vectorizer, bigram_vectorizer=bigram_vectorizer
    )
