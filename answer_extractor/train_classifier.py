...
DROPPED_COLUMNS = ["Index", "Input", "Answer", "Answer_lowercase", "Answer_without_stop_words", "Type", "Label"]
...
def train_classifier():
    ...
    X_train, X_test, y_train, y_test = train_test_split(data.drop(DROPPED_COLUMNS, axis=1), data["Label"], test_size=0.05, random_state=42)
